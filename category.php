  ...
  ?>  
          ...
          <div class="panel panel-primary">
              ...
              <!--           <div class="col-sm-6">
                    ...
                    <div class="col-sm-2" > <a href="<?php echo web_root; ?>index.php?q=apply&job=<?php echo $result->JOBID;?>&view=personalinfo" style="background-color: #0000FF;" class="btn btn-main btn-next-tab">Apply </a></div>
                </div> 

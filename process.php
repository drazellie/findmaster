...
function doUpdate($jobid=0,$fileid=0) {
	...
	global $mydb;   
			...
			message("Your application already submitted. Please wait for the company confirmation if your are qualified for this job.","success");
			redirect("index.php?q=success&job=".$result->JOBID);
...
function doRegister(){
	...
	if (isset($_POST['btnRegister'])) { 
			...
			message("You are successfully registered!","success");
...
|| $imageFileType != "gif" ) {
		 if (move_uploaded_file($_FILES["picture"]["tmp_name"], $target_file)) {
			...
			message("Please Upload your Resume","error");

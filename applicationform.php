                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body"> 
                            ...
                            <div class="col-md-10" style="padding: 0;margin: 0;">
                                ...
                                <input name="MAX_FILE_SIZE" type="hidden" value="1000000" required> 
                            </div> 
                        </div>
                    </div> 
                </div> 
              ...
              <div class="col-sm-12">
                <div class="row">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body"> 
                            <label class="col-md-2" for="picture" style="padding: 0;margin: 0;color: #000;">Attachtment File:</label> 
                            <div class="col-md-10" style="padding: 0;margin: 0;color: #000;">
                                <input id="picture" name="picture" type="file">

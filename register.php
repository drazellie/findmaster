		...
		<div class="row"> 
			  ...
			  <div class="col-md-8" style=" color: #000;">
			    ...
			    <div class="col-md-8">
			      ...
			      <input  class="form-control input-sm" id="PASS" name="PASS" placeholder=
			          "Password" type="password"   onkeyup="javascript:capitalize(this.id, this.value);" required autocomplete="off">
			       <!-- <input class="form-control input-sm" id="DEPARTMENT_DESC" name="DEPARTMENT_DESC" placeholder=
			          "Description" type="text" value=""> -->
			    </div>
			  </div>
			  ...
			  <div class="col-md-8" style=" color: #000;">
			    ...
			    <div class="col-md-8">
			      ...
			      <input  class="form-control input-sm" id="DEGREE" name="DEGREE" placeholder=
			          "Educational Attainment"    onkeyup="javascript:capitalize(this.id, this.value);" required autocomplete="off">
			      </div>
			  </div>
			</div>  
			<div class="form-group">
			...
			<div class="form-group">
			    <div class="col-md-8">
			      ...
			      "idno"></label>  
			      <div class="col-md-8">
			         <button class="btn btn-primary" name="btnRegister" type="submit" ><span class="fa fa-save fw-fa"></span> Register</button> 
